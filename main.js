...
let Quote1: string ="KEEP AWAY from people who try to belittle \nYOUR AMBITIONS. small people always do that \nBUT THE REALLY GREAT make you feel that \nYOU TOO, can become GREAT.";
let Author: string ="Mark Twain ";
...
let newQuote: string ="Knowledge without action is like a tree without fruit";
let famouse_persone ="Hazrat Ali(S.A)";
let message = `${famouse_persone}once said, ${newQuote}`;
...
var strippped = WhitespaceName.trim();
...
//My Name is Kanwal Naeem
//To Day Date is 20/may/2024
//This program will plus
console.log(4 + 3);
QUESTION_NUMBER: 11;
//Names: Store the names of a few of your friends in a array called names. Print each person’s name by accessing each element in the list, one at a time.
/*console.log("\t \t ANSWER_NUMBER : 11 \n");

let familyMembers: string[] =[`Shakial`,`Ansho`,`guria`,`baba`,`Naeem`,`sir gee`];
for(let l=0; l<familyMembers.length; l++){
    console.log(familyMembers[l]);
}*/
QUESTION_NUMBER: 12;
//Greetings: Start with the array you used in Exercise 11, but instead of just printing each person’s name, print a message to them. The text of each message should be the same, but each message should be personalized with the person’s name.
/*console.log("\t \t ANSWER_NUMBER : 12 \n");

let Members: string[] =[`naeem `,`guria  `,`sir gee  `,`shakial `];
let Message: string= `Are you coming today at my home?`;
...
let transpotations: string [] =[ " Mercedes"," Audi A4"," bike","Honda"];
...
let Guest_list1 : string[] = [`Zamzam`,`Naeem`,`kanwal`,`Hamad`,`amna`];
for(let i=0; i<Guest_list1.length; i++){
    console.log("Requested Friend:"+Guest_list1[i]+ ',\nyou are invited to dinner tomorrow .\n Inshallah See you tomorrow.\n');
}*/
QUESTION_NUMBER: 15;
...
let Guest_list2 : string[] = [`Zamzam`,`Naeem`,`Kanwal`,`Hamad`,`Amna`];
for(let i=0; i<Guest_list2.length; i++){
    console.log(`Respected Friend, `+Guest_list2[i]+ ',\nWe invited you on dinner tomorrow.\nThank you\n');
}
let not_present1 : string='Zamzam';
let new_guest1 : string='Naveed khan';
Guest_list2[2] = new_guest1;
for(let i=0; i<Guest_list2.length; i++){
...
var Guest_list = ["Zamzam", "Hamza", "Amna", "Mustafa", "Naeem"];
// Making varibale for those who is not present
var not_present = 'Naeem';
// New Guestlist member
var new_guest = 'Naveed khan';
...
var Guest_list3 = ["Ali", "Ahmed", "farhan", "Rizwan"];
// One member is not preasent thats way we invite 1 new_Guest
var not_present2 = "Farhan";
var new_guest2 = "Asad";
...
var places_name = ["Rome", "Dubia", "Bangkok", "Cape Town", "Istanbul"];
console.log('original order: ' + places_name);
// Print the array in Alphabetical order without mobifing the actal list
console.log('copy: ' + __spreadArray([], places_name, true).sort());
// Show that your array is still in its original order by printing it
console.log('original: ' + places_name);
// Print your array in reverse alphabetical order without changing the order of the original list
console.log('copy: ' + __spreadArray([], places_name, true).sort().reverse());
// Show that your array is still in its original order by printing it again
console.log('copy: ' + __spreadArray([], places_name, true).sort().reverse());
...
console.log("\n \t \t ANSWER_NUMBER : 19 \n");
var Guest_list4 = ["Ali", "Alisha", "Fatima", "Usman"];
for (var i = 0; i < Guest_list4.length; i++) {
    console.log('Respected sir ' + Guest_list4[i] + ',\nwe invited you on dinner tomorrow.\nThank you\n');
}
console.log("\n PERINTING NUMBER OF GUEST INVITED");
console.log("we had finally invited ".concat(Guest_list4.length, " people"));
EXERCISE_NUMBER: 20.;
//Think of something you could store in a array. For example, you could make a list of mountains, rivers, countries, cities, languages, or anything else you’d like. Write a program that creates a list containing these items.
console.log("\n \t \t ANSWER_NUMBER : 20 \n");
var Mountains = ['Mount Fuji(Japan)', 'Appalachian Mountain(USA)', 'Andes Mountain(south America)', 'Mount Etna(Italy)'];
console.log("list of mountains:");
for (var _i = 0, Mountains_1 = Mountains; _i < Mountains_1.length; _i++) {
    var top_1 = Mountains_1[_i];
    console.log(top_1);
}
EXERCISE_NUMBER: 21.;
...
console.log("pizza : ".concat(pizza.name, ",\namount: ").concat(pizza.amount));
console.log("vegitable: ".concat(sandwhich.name, ",\namount: ").concat(sandwhich.amount));
EXERCISE_NUMBER: 22;
//Intentional Error: If you haven’t received an array index error in one of your programs yet, try to make one happen. Change an index in one of your programs to produce an index error. Make sure you correct the error before closing the program
console.log("\t \t ANSWER_NUMBER : 22 \n");
var array = ['tayab', 'baber', 7, 8, 9, 10];
console.log(array[3]);
console.log(array[0]);
...
console.log(twenty < ten || twenty != twenty);
var ice_cream = ["strawberry", "banana", "blue berry", "black berry"];
...
console.log("\n \t \t ANSWER_NUMBER : 29 \n");
var favorite_fruits = ["Blue Berry", "Graps", "Mango"];
...
console.log("\n \t \t ANSWER_NUMBER : 30 \n");
var userNames = ["Iqra", "Khan", "Tanoli", "Usman", "Admin"];
...
console.log("\n \t \t ANSWER_NUMBER : 31 \n");
var userNames1 = ["Usama", "Umer", "salman", "subhan", "Manzoor"];
userNames = [];
...
console.log("\n \t \t ANSWER_NUMBER : 32 \n");
var current_users = ["amain", "Fatima", "Alisha", "Areeba", "Manal"];
var new_users = ["Sakhina", "Amain", "Manal", "Iqra", "saba"];
...
// creating a arry
var Pizza = ["Malli boti", "chicken tikka", "spicy tikka"];
// using for-loop
for (var _b = 0, Pizza_1 = Pizza; _b < Pizza_1.length; _b++) {
    var onepizza = Pizza_1[_b];
...
console.log("\n \t \t ANSWER_NUMBER : 35 \n");
// creating a Arry
var petAnimals = ["Rabbit", "Elephant", "Parrot"];
// Using For-loop
for (var _c = 0, petAnimals_1 = petAnimals; _c < petAnimals_1.length; _c++) {
    var onePet = petAnimals_1[_c];
...
function make_shirt(size, printMessage) {
    ...
    if (printMessage === void 0) { printMessage = "I Love TypeScrity."; }
...
var album1 = make_album("Asim But", "A graffiti artist");
console.log(album1);
var album2 = make_album("Ahmed Parvez", "A modernist painter");
console.log(album2);
var album3 = make_album("Iqbal Geoffrey", "A Calligrapher");
console.log(album3);
EXERCISE_NUMBER: 41;
...
var Magicion_Names = ["Harry Houdini", "Criss Angel", "Harry Blackstone jr"];
...
var magician_name = ["Dynamo", "Penn and Teller", "Criss Angel"];
// Call make_great function to modify magicians names
var great_magician = make_greats(magician_name);
...
var magician_names = ["Dynamo", "Penn and Teller", "Criss Angel"];
...
var myCar = CarInfo('Toyota', 'civic', { colour: 'Black', year: '2023' });
