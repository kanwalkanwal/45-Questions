...
let strippped: string = WhitespaceName.trim();
...
let Guest_list : string[] = [`Zamzam`,`Hamza`,`Amna`,`Mustafa`,`Naeem`];

// Making varibale for those who is not present
let not_present : string='Naeem';

// New Guestlist member
let new_guest : string='Naveed khan';
...
let Guest_list3 : string[] =[`Ali`,`Ahmed`,`farhan`,`Rizwan`];

// One member is not preasent thats way we invite 1 new_Guest
let not_present2 : string = `Farhan`;
let new_guest2 : string = `Asad`;
...
let places_name : string [] = [ `Rome`,`Dubia`,`Bangkok`,`Cape Town`,`Istanbul`];
...
let Guest_list4 : string [] = [`Ali`,`Alisha`,`Fatima`,`Usman`];
...
let Mountains : string[] =['Mount Fuji(Japan)','Appalachian Mountain(USA)','Andes Mountain(south America)','Mount Etna(Italy)'];
...
let array: (string|number) []= ['tayab','baber',7,8,9,10];
console.log(array[3]);
console.log(array[0]);
...
let alien_colour1 : string = "Black";
...
function make_shirt1 (size : string, printMessage: string){
...
// Making a function
function make_shirt (size: string = "Large", printMessage: string= "I Love TypeScrity."){
...
// Describe a function
function Describe_city (City: string, Country: string = "Germany"){
